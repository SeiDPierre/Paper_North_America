...
The dataset includes three component acceleration waveforms from more than 2400 permanent and temporary broadband stations located in the target region, a $90^o \times 90^o $ area encompassing most of north America (Fig. 3). We considered two different datasets:
\begin{itemize}
...
\begin{tabular}{ccc}
(a)&&(b)\\
  \includegraphics[width=.45\textwidth]{snap_glob.pdf}  &&
  \includegraphics[width=.45\textwidth]{snap_reg.pdf} \\ 
  \includegraphics[width=.45\textwidth]{seismo.pdf}      &&
  \includegraphics[width=.45\textwidth]{seismo.pdf}
\end{tabular}
\caption{\label{injection}Comparison between a global scale simulation and a regional scale simulation of wave propagation following an earthquake in south America. The seismograms corresponds to the recordings at 37 station located in north America (red spheres). The pink sphere shows the epicenter of the earthquake. In (a), the wavefield is modeled globally using the spectral element method Specfem3D\_globe \citep{komatitsch2002spectrala}. In (b), the wavefield is modeled regionally using the RegSEM  
...
% \subsection{Tectonic back ground}

% Cratons are large areas of continental lithosphere that have remained coherent and relatively rigid since Precambrian \citep{hoffman1988united}. Through more than $3Ga$, cratons have survived compared to the $<200Ma$ life span of ocean basins.
% In accordance with the absence of geoid anomalies over continents, Jordan proposed the concept of Continental Tectosphere \citep{jordan1975continental} where continental mantle is made of low-density, melt-depleted peridotite residua, whose low densities exactly offset the effect of thermal contraction associated with a growing thermal boundary layer \citep{lee2011building}.
% The fact that the continental lithosphere manages to avoid the fate of recycling suffered by oceanic lithosphere has been attributed to high viscosity \citep{sleep2003survival, doin1997mantle}, neutral to positive buoyancy, low heat flow compared to surronding area \citep{jaupart2014building}, dehydrated \citep[i.e dryer than oceanic mantle until 250km deep according to electrical conductivity tomography,][]{yang2015three, hirth2000comparison}, and chemically depleted until ca. 175km deep \citep{kopylova1999petrology} while still fertile below until ca. 300km \citep{s2005archean}. 

% Since \cite{grand1984upper}, one well established feature within NA lithosphere is the contrast between the high velocity craton and the low velocity western active part. This feature is observed in many global models (e.g., \citep{megnin2000three, shapiro2002monte, panning2006three, houser2008shear, nettles2008radially, kustowski2008anisotropic, ritsema2010s40rts, simmons2010gypsum, lekic2011inferring, debayle2012global, schaeffer2013global, french2014whole,bozdag2016global} where the cratonic lithosphere is caracterized by higher than average (ca. $4.8 km.s^{-1}$) velocities down to at least $200km$ deep. 

% % Such values, at upper mantle depths with Standart Temperature Condition, are very important when interpreting shear wave velocities. For example, a relatively small velocity increase of $1 \%$ in the uppermost mantle can be attributed to a $5$ unit increase in the Mg\# relative to Fe, or an $220°C$ decrease in temperature. \citep{lee2003compositional, bedle2009svelocity}

% % The combination of low temperature and depleted lithosphere induces observed high velocity anomalies.

% Continental scale studies showed that, fastest anomalies are beneath archean and proterozoic terranes around 150km deep \citep{bedle2009svelocity,lee2005surface,schaeffer2014imaging,marone2007three,yuan20113}, there are correlations between surface tectonics provinces and shear waves velocities heterogeneities \citep{nettles2008radially,yuan2014lithospheric,darbyshire2013seismic}, upper mantle cratonic keels extends down to ca. 250km with lateral thin out downward. \cite{yuan2010lithospheric} infered from azimuthal anisotropy study, that cratonic keels are vertically stratified and comprise a cold core of highly depleted material bounded deeper by a fertile (less depleted) thermal layer. While the sharp Mid-Lithospheric Discontinuity (MLD) between the chemical layer and thermal layer is observed (e.g \cite{thybo1997seismic,abt2010north,calo2016layered}), the Lithosphere-Asthenosphere Boundary (LAB) is more diffuse and is identified as flat in topography through a negative gradient in shear wave velocities associated with an alignement of anisotropic fast axes direction with Absolute Plate Motion. \citep{yuan2010lithospheric,eaton2009elusive}\\

% At local scale, it has been observed that the stagnant shield suffered deformations from the convective mantle \citep{kaban2015cratonic,eaton2007seismic,frederiksen2013modification,boyce2016subduction}

% !!! Still a lot of local studies to include,  Greenland, deep slab imaged, Wyoming, talk more about Divot, Hotspots, Appalachian, Gulf of Mexico, JdF. !!!
% % This structure expands over both Archean and Proterozoic terranes in the canadian shield, which is not necessarly the case for all archean terranes within the plate (e.g the Wyoming block in the US \citep{yuan2014lithospheric}).

% Such high shear wave velocity values, at upper mantle depths with Standart Temperature Condition, are very important when interpreting shear wave velocities. For example, a relatively small velocity increase of $1 \%$ in the uppermost mantle can be attributed to a $5$ unit increase in the Mg\# relative to Fe, or an $220°C$ decrease in temperature. \citep{lee2003compositional, bedle2009svelocity}

% Mechanism for craton formation is debated (e.g., \cite{lee2011building} \cite{s2005archean}), and caracterizing cratons through high resolution imaging gives clues to elucidate this puzzle.
% We propose interpretations on the geologic and tectonic evolution of the continent since both parameter variabilities are related to compositional, mineralogical and thermal states of the mantle.




% The North American (NA) continent is fully part of the North American plate. This tectonic plate is moving at ca. $2cm$ per year in a west-south westerly direction around a rotation pole located in north western Ecuador \citep{bleeker2005north} Along its western margin, we can find:
%  \begin{itemize}
%  	\item Subduction of the Pacific plate under NA plate south to Alaska, the Cascadian subduction zone of the Juan de Fuca plate and the Coco plate subducting under central America, both generating arc volcanism and being part of the ancient Farallon plate which was subducting under NA plate since Jurassic period.
%  	\item Strike-slip along the Queen Charlotte-Fairweather system in Canada and along the San Andreas fault in California.
%  \end{itemize}
 

%  The evolution of western North America has been controlled by this Mesozoic-Cenozoic ocean-continent collisional system. 
%  Subduction events of oceanic lithosphere are thought to be responsible for the Laramide orogeny (Late Cretaceous), characterized by minor horizontal shortening in the crust, but considerable crustal thickening generating the rocky mountains (Bird 1988).
%  The Rocky-Mountain Front (RMF) almost perfectly coincides with the boundary between this tectonically active area and the more stable cratonic part.

%  Two third of the Laurentia craton consist of distinct archean provinces: 
% \begin{itemize}
% 	\item undeformed Slave, Superior and Wyoming cratons
% 	\item highly reworked Rae and Hearne cratons (Churchill structural Province)
% 	\item Nain and North Atlantic Craton (NAC) underlying southern Greenland
% 	\item Sask which underlies the Trans-Hudson orogen Proterozoic belts (THO)
% \end{itemize}
%   All of these archean blocks, comprising most of the Canadian shield, were mainly welded by Proterozoic belts like the THO, but it is still under debates whether archean blocks originated from related ancestral landmasses (i.e a unique super craton, a couple of super cratons, or many super cratons). Greenland, despite its continental part was separated from NA continent ca. $80Ma$ ago, is fully part of the NA plates. While the NAC on its southern part has being studied over the last decades, central (Apparently a continuity of the THO \cite{bleeker2005north} and northern (apparently Rae-like archaean blocks) part are still poorly documented.

%  In the periphery of this NA archean core, proterozoic belts like Wopmay, Penokean and Makkovik-Ketilian orogens from 2.0 to 1.8 Ga and Labradorian, Central Plains and Yavapai-Mazatzal orogens from 1.8 to 1.6 Ga represent zones of accretion for Proterozoic material and mark the amalgamation of the archean cores. \citep{hoffman1988united} 
%  The Grenvile orogen (ca. $1.1 Ga$) at the southeast of the craton core completed to shape the Laurentia craton as we can observe it today, surviving both Rodinia ($825-550Ma$) and Pangaea ($335-175Ma$) break-ups. 


\section{Results}

\subsection{Continental model}
To link with the 1D profile!
As observed in many other studies, average profiles of $V_S$ within North America (NA) in the shallow upper mantle is higher compared to Global average profiles biased by ocean structures. 
...
\label{cratoncross}
% \begin{tabular}{ccc}
\includegraphics[width=.45\textwidth]{/Users/Pierre/Documents/MATLAB/figures/iter2/profiles_NASEM_vs_dxi_A.pdf}  &&
% \end{tabular}
\caption{\bm{Cross Section of the lithospheric core}}
\end{figure}


To link with slices and a set of profiles
...
As observed in Gung et al., 2003; down to 250km negative anomalies of $dln(\xi)$ are observed in the whole craton. 
...
The Archaean aged Wyoming craton does not show as high anomalies as within the craton nucleus. 
...
\subsubsection{Slave}
The Archaean aged Slave craton shows typical lithospheric craton signatures with higher than average velocities. 
...
The Archaean aged Superior craton shows typical lithospheric craton signatures with higher than average velocities. 
It shows in the entire region a positive velocity gradient with a maximum of ca. $4.8km.s^{-1}$  associated with a maximum of $\xi$ at ca. $150km$ deep.
Deeper a negative gradient is observed with a minimum of ca. $4.6km.s^{-1}$ at ca. $250km$ deep. 
...
Compared to its western part, the structure here shows differences. 
